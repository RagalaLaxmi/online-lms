...
<div class="container">
        ...
        <tbody>
            <?php foreach ($courses as $course): ?>
                <tr>
                    ...
                    <td>
                        <a href="edit_course1.php?id=<?= $course['id'] ?>">Edit</a> |
                        <a href="manage_courses1.php?delete=<?= $course['id'] ?>" onclick="return confirm('Are you sure you want to delete this course?')">Delete</a>
                    </td>
                </tr>
            <?php endforeach; ?>
        </tbody>
    ...
    <br>
    <a href="add_course1.php" class="button">Add New Course</a>
</div>
